...
pub fn syscall(args: SyscallArgs) -> SyscallResult {
    ...
    match id {
        ...
        SyscallId::Ioctl => todo!(),
        SyscallId::Mkdir => todo!(),
        SyscallId::UnlinkAt => todo!(),
        SyscallId::LinkAt => todo!(),
        SyscallId::OpenAt => todo!(),
        SyscallId::Lseek => todo!(),
        SyscallId::Readv => todo!(),
        SyscallId::Writev => todo!(),
        SyscallId::Pread => todo!(),
        SyscallId::ExitGroup => todo!(),
        SyscallId::NanoSleep => todo!(),
        SyscallId::ClockGetTime => todo!(),
        SyscallId::GetTimeOfDay => todo!(),
        SyscallId::Brk => todo!(),
        SyscallId::Munmap => todo!(),
        SyscallId::Mmap => todo!(),
        SyscallId::Mprotect => todo!(),
        SyscallId::PriLimit64 => todo!(),
    }
}